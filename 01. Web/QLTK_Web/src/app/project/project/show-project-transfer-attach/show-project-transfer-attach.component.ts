...
@Component({
  selector: 'app-show-project-transfer-attach',
  templateUrl: './show-project-transfer-attach.component.html',
  styleUrls: ['./show-project-transfer-attach.component.scss']
})
export class ShowProjectTransferAttachComponent implements OnInit {
