...
@Component({
  selector: 'app-show-project-attach-tab',
  templateUrl: './show-project-attach-tab.component.html',
  styleUrls: ['./show-project-attach-tab.component.scss']
})
export class ShowProjectAttachTabComponent implements OnInit {
  ...
  getProjectAttach() {
    ...
    this.projectAttachService.getProjectAttach(this.model).subscribe((data: any) => {
      if (data) {
        ...
        // this.model.TechnicalFiles = data.TechnicalFiles;
        // this.model.OtherFiles = data.OtherFiles;
      }
    }, error => {
