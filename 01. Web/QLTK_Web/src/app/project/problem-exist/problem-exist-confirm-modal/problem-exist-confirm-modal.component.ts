...
@Component({
  selector: 'app-problem-exist-confirm-modal',
  templateUrl: './problem-exist-confirm-modal.component.html',
  styleUrls: ['./problem-exist-confirm-modal.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ProblemExistConfirmModalComponent implements OnInit {
  ...
  modalInfo = {
    Title: 'Xác nhận vấn đề',
  };

  ngOnInit() {
    this.fileProcess.FilesDataBase = [];
    this.model.Id = this.Id;
    this.modalInfo.Title = 'Xác nhận vấn đề';
  ...
  getErrorInfo() {
    this.serviceError.getErrorInfo(this.model).subscribe(data => {
      ...
      this.modalInfo.Title = "Xác nhận vấn đề - " + data.Code;
