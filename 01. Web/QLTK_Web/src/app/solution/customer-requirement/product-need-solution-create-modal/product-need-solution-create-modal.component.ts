...
@Component({
  selector: 'app-product-need-solution-create-modal',
  templateUrl: './product-need-solution-create-modal.component.html',
  styleUrls: ['./product-need-solution-create-modal.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ProductNeedSolutionCreateModalComponent implements OnInit {
  ...
  getById()
  {
    this.customerRequirementService.getProductNeedSolutionById(this.Id).subscribe(
      data => {
        this.model = data;
