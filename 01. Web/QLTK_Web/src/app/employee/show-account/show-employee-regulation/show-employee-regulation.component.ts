...
@Component({
  selector: 'app-show-employee-regulation',
  templateUrl: './show-employee-regulation.component.html',
  styleUrls: ['./show-employee-regulation.component.scss']
})
export class ShowEmployeeRegulationComponent implements OnInit {
