...
@Component({
  selector: 'app-choose-flow-stage',
  templateUrl: './choose-flow-stage.component.html',
  styleUrls: ['./choose-flow-stage.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ChooseFlowStageComponent implements OnInit {
  ...
  search() {
    ...
    this.outputResultService.searchFlowStage(this.modelSearch).subscribe(data => {
