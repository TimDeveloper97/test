...
import { EmployeeWorkTypeService } from 'src/app/employee/service/employee-work-type.service';

@Component({
  selector: 'app-show-select-skill-employee',
  templateUrl: './show-select-skill-employee.component.html',
  styleUrls: ['./show-select-skill-employee.component.scss'],
  encapsulation: ViewEncapsulation.None

})
export class ShowSelectSkillEmployeeComponents implements OnInit {
  ...
  searchSkill() {
    ...
    this.workTypeService.searchEmployeeWorkSkill(this.model).subscribe(data => {
