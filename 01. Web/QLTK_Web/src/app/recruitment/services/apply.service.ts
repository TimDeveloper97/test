...
export class ApplyService {
  ...
  getSalaryByRequestId(id: any): Observable<any> {
    var tr = this.http.get<any>(this.config.ServerWithApiUrl + 'recruitment-request/get-salary-by-request-id/' + id, httpOptions);
    return tr
  }
  ...
  createCandidateApply(model: any): Observable<any> {
    var tr = this.http.post<any>(this.config.ServerWithApiUrl + 'apply/create-candidateapply', model, httpOptions);
    return tr
  }

  getCandidateApplyById(id: any): Observable<any> {
    var tr = this.http.get<any>(this.config.ServerWithApiUrl + 'apply/get-candidate-apply-by-id/' + id, httpOptions);
    return tr
  }

  updateCandidateApply(id, model: any): Observable<any> {
    var tr = this.http.post<any>(this.config.ServerWithApiUrl + 'apply/update-candidate-apply/' + id, model, httpOptions);
    return tr
  }

  ApplyExport(model: any, idCheck): Observable<any> {
    var tr = this.http.post<any>(this.config.ServerWithApiUrl + 'apply/ApplyExport?idcheck=' + idCheck, model, httpOptions);
    return tr
  }

  InterviewExport(id:any): Observable<any> {
    var tr = this.http.post<any>(this.config.ServerWithApiUrl + 'apply/InterviewExport/' + id, httpOptions);
    return tr
  }
