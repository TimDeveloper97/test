...
export class InterviewService {
  ...
  getEmployee(id: any): Observable<any> {
    var tr = this.http.get<any>(this.config.ServerWithApiUrl + 'interview/getEmployee/' + id, httpOptions);
    return tr
  }

  updateEmployee(id, model: any): Observable<any> {
    var tr = this.http.post<any>(this.config.ServerWithApiUrl + 'interview/updateEmployee/' + id, model, httpOptions);
    return tr
  }

  updateQuestions(id, model: any): Observable<any> {
    var tr = this.http.post<any>(this.config.ServerWithApiUrl + 'interview/updateQuestions/' + id, model, httpOptions);
    return tr
  }
}
