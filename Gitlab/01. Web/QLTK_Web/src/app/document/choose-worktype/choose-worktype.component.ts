...
@Component({
  selector: 'app-choose-worktype',
  templateUrl: './choose-worktype.component.html',
  styleUrls: ['./choose-worktype.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ChooseWorktypeComponent implements OnInit {
  ...
  searchWorkType() {
    ...
    this.documentService.searchWorkType(this.modelSearch).subscribe(data => {
