...
@Component({
  selector: 'app-show-project-general-design',
  templateUrl: './show-project-general-design.component.html',
  styleUrls: ['./show-project-general-design.component.scss']
})
export class ShowProjectGeneralDesignComponent implements OnInit {
