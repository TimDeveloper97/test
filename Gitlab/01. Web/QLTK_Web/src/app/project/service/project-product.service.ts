...
export class ProjectProductService {
  ...
  searchProjectProductQc(model: any): Observable<any> {
    var tr = this.http.post<any>(this.config.ServerWithApiUrl + 'ProjectProduct/SearchProjectProductQc', model, httpOptions);
    return tr
  }

  ExportExcelQC(model: any): Observable<any> {
    var tr = this.http.post<any>(this.config.ServerWithApiUrl + 'ProjectProduct/ExportExcelQC', model, httpOptions);
    return tr
  }

  searchShowProjectProductQc(model: any): Observable<any> {
    var tr = this.http.post<any>(this.config.ServerWithApiUrl + 'ProjectProduct/searchShowProjectProductQc', model, httpOptions);
    return tr
  }

  searchCheckList(id:any): Observable<any>{
    var tr = this.http.post<any>(this.config.ServerWithApiUrl + 'ProjectProduct/SearchCheckList/'+id, httpOptions);
  return tr
  }

  AddChecklisst(model:any): Observable<any> {
    var tr = this.http.post<any>(this.config.ServerWithApiUrl + 'ProjectProduct/AddChecklisst', model, httpOptions);
    return tr
  }

  deleteQCChecklist(id:any): Observable<any> {
    var tr = this.http.post<any>(this.config.ServerWithApiUrl + 'ProjectProduct/deleteQCChecklist/'+ id, httpOptions);
    return tr
  }
  copyQCCheckList(model: any): Observable<any> {
    var tr = this.http.post<any>(this.config.ServerWithApiUrl + 'ProjectProduct/copyQCCheckList', model, httpOptions);
    return tr
  }

  SelectStandard(model: any): Observable<any> {
    var tr = this.http.post<any>(this.config.ServerWithApiUrl + 'ProjectProduct/SelectStandard', model , httpOptions);
    return tr
  }
  deleteAllHasQc(id:any): Observable<any> {
    var tr = this.http.post<any>(this.config.ServerWithApiUrl + 'ProjectProduct/DeleteAllHasQc/'+ id, httpOptions);
    return tr
  }
  GetProjectProductCopyQC(model: any): Observable<any> {
    var tr = this.http.post<any>(this.config.ServerWithApiUrl + 'ProjectProduct/GetProjectProductCopyQC', model, httpOptions);
    return tr
  }
