...
@Component({
  selector: 'app-meeting-finish-manage',
  templateUrl: './meeting-finish-manage.component.html',
  styleUrls: ['./meeting-finish-manage.component.scss']
})
export class MeetingFinishManageComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.appSetting.PageTitle = "Danh sách Meeting kết thúc";
    this.searchMeeting();
  }
